...
void setup() {
  // Initialize pin D2 as output (to LED), initialize A0 as analog input.
  pinMode(D2, OUTPUT);
  pinMode(A0, INPUT);

  ledcSetup(0, 1000, 12);   // PWM channel 0, arbitrary frequency of 1000 Hz, resolution of 12 bits (analog read maxes at 2^12-1, 4095)
